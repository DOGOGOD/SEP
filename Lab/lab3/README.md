## [](#Lab-3-汉诺塔 "Lab-3-汉诺塔")Lab 3: 汉诺塔

在Lab 3中，你需要设计并实现一个游戏：汉诺塔。

## [](#1-汉诺塔问题 "1-汉诺塔问题")1\. 汉诺塔问题
...
## [](#4-面向对象和数据结构 "4-面向对象和数据结构")4\. 面向对象和数据结构

要完成这个实验，你需要了解C++面向对象编程以及基本的数据结构知识（如栈和队列）。  
在本实验中，你需要根据我们的设计来实现对应的数据结构。

### [](#41-链表、栈、队列 "41-链表、栈、队列")4.1 链表、栈、队列
...
### [](#51-需要实现的文件 "51-需要实现的文件")5.1 需要实现的文件
